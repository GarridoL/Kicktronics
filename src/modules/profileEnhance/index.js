      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View
          ...
          <View
            ...
            <View style={{width: '50%'}}>
              <TouchableOpacity
                style={[Style.btnWithShadow, {width: 150, height: 150}]}
                onPress={() => this.props.navigation.navigate('purchaseStack')}>
                <FontAwesomeIcon
                  icon={faShoppingBag}
                  size={40}
            ...
            <View>
              <TouchableOpacity
                style={[Style.btnWithShadow, {width: 150, height: 150}]}
                onPress={() => this.props.navigation.navigate('supportStack')}>
                <FontAwesomeIcon
                  icon={faHeadset}
                  size={40}
                  color={'gray'}></FontAwesomeIcon>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProfileEnhance);
